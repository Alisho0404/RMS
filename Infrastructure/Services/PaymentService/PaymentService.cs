...
public class PaymentService(ILogger<PaymentService> logger, DataContext context) : IPaymentService
{
    ...
    public async Task<Response<string>> CreatePaymentAsync(CreatePaymentDto createPayment)
    {
        try
        {
            ...
            if (createPayment.PaymentStatus == Domain.Enums.PaymentStatus.Completed) newPayment.PaymentStatus = "Completed";
            if (createPayment.PaymentStatus == Domain.Enums.PaymentStatus.Cancelled) newPayment.PaymentStatus = "Cancelled";
